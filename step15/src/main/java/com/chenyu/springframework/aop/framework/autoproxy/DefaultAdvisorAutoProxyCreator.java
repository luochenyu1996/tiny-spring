package com.chenyu.springframework.aop.framework.autoproxy;

import com.chenyu.springframework.aop.*;
...
import com.chenyu.springframework.beans.factory.BeanFactoryAware;
import com.chenyu.springframework.beans.factory.config.InstantiationAwareBeanPostProcessor;
 ...
 * 和工厂进行整合
 *
 * 最完整的封装，通过关联 ProxyFactory 创建代理对象
 *
 *
 *
 * 封装了代理类的创建过程 以便和 IOC 进行整合
 *
 * @author chen yu
 * @create 2022-01-31 22:26
 */
